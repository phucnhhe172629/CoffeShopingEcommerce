...
<html lang="en">
    ...
    <body>
        <div class="container-xxl position-relative bg-body d-flex p-0">
            ...
            <form action="edit-category" method="post" class="col-12">
                ...
                <div class="modal-body">	
                    <div class="form-group">
                        <label>ID</label>
                        <input name="id" type="text" class="form-control" value="${c.id}" readonly required>
                    </div>
                    <div class="form-group">
                        <label>Tên</label>
                    ...
                    <div class="form-group">
                        <label>Mô tả</label>
                        <textarea name="description" class="form-control" value="${c.description}" required></textarea>
                    </div
